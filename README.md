...
You can view the evaluation reports at [https://test-organization-2026.github.io/wasp-benchmark/](https://test-organization-2026.github.io/wasp-benchmark/).
...
```bash
harbor run     --agent codex     --model "gpt-5.2-codex"     --env daytona     --path ./tasks     --n-attempts 1     --max-retries 5     --n-concurrent 5     --retry-include RuntimeError     --retry-include DaytonaError     --retry-include AgentTimeoutError
```
